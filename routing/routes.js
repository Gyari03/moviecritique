...
function subscribeToRoutes(app){
    const objRepo = {};
    app.get('/',authMW(objRepo),loadMoviesMW(objRepo),renderMW(objRepo));
    app.get('/login',checkLoginMW(objRepo),renderMW(objRepo));
    app.post('/login',loginMW(objRepo));
    app.get('/movie/:id',authMW(objRepo),renderMW(objRepo));
    app.post('/movie/:id/delete',authMW(objRepo),deleteMovieMW(objRepo));
    app.get('/movie/:id/edit',authMW(objRepo),renderMW(objRepo));
    app.post('/movie/:id/edit',authMW(objRepo),saveMovieMW(objRepo));
    app.post('/movie/:id/comment',authMW(objRepo),saveCommentMW(objRepo));
    app.get('/movie/new',authMW(objRepo),renderMW(objRepo));
    app.post('/logout',authMW(objRepo),logoutMW(objRepo));
    app.get('/profile',authMW(objRepo),renderMW(objRepo));
